...
public class ParamDialog extends Dialog {
    ...
    @BindView(R.id.edtUsefulArea)
    AppCompatEditText edtUsefulArea;
    @BindView(R.id.edtColdArea)
    AppCompatEditText edtColdArea;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getContext(), R.layout.param_dialog, null);
        setContentView(view);
...
//        getWindow().setAttributes(params);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.btnOk:
                Toast.makeText(getContext(), "be server request bezan", Toast.LENGTH_SHORT).show();
                break;
            case R.id.btnCancel:
                dismiss();
                break;
