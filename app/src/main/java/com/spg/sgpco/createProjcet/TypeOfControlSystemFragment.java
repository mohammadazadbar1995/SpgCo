...
public class TypeOfControlSystemFragment extends Fragment implements TypeOfCotrolSystemsAdapter.OnItemClickListener {
    ...
    private void setAdapter() {
        TypeOfCotrolSystemsAdapter adapter = new TypeOfCotrolSystemsAdapter(getActivity(), systemsItems, this);
    ...
    public void onItemClick(int position, SystemsItem systemsItem) {
        ...
        intent.putExtra("SystemsItems", systemsItems.get(position));
