...
public class GetDownloadListService {


    private static GetDownloadListService getDownloadListService;

    public static GetDownloadListService getInstance() {
        if (getDownloadListService == null) {
            getDownloadListService = new GetDownloadListService();
        }
        return getDownloadListService;
    }


    public void getDownloadList(final Resources res, final ResponseListener<DownloadListResponse> responseListener) {
        new ServerTransaction().setCall(res, ApiClient.getClient().create(ReqInterface.class).getDownloadList(), new ServerListener() {
            @Override
            ...
            public void onSuccess(JsonObject jsonObject) throws JSONException, UnsupportedEncodingException {
                ...
                try {
                    ...
                    DownloadListResponse response = gson.fromJson(mJson, DownloadListResponse.class);
