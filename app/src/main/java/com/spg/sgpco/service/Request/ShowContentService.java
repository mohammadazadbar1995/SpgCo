...
public class ShowContentService {
    ...
    private static ShowContentService showContentService;

    public static ShowContentService getInstance() {
        if (showContentService == null) {
            showContentService = new ShowContentService();
        }
        return showContentService;
    }


    public void getShowContent(final Resources res, final ResponseListener<ShowContentResponse> responseListener) {
        new ServerTransaction().setCall(res, ApiClient.getClient().create(ReqInterface.class).showContent(), new ServerListener() {
            @Override
            ...
            public void onSuccess(JsonObject jsonObject) throws JSONException, UnsupportedEncodingException {
                ...
                try {
                    ...
                    ShowContentResponse response = gson.fromJson(mJson, ShowContentResponse.class);
