...
public class UpdateCustomerService {
    ...
    private static UpdateCustomerService updateCustomerService;

    public static UpdateCustomerService getInstance() {
    ...
    public void updateCustomer(final Resources res, UpdateCustomerReq req, final ResponseListener<UpdateCustomerResponse> responseListener) {
        new ServerTransaction().setCall(res, ApiClient.getClient().create(ReqInterface.class).updateCustomer(req), new ServerListener() {
            @Override
            ...
            public void onSuccess(JsonObject jsonObject) throws JSONException, UnsupportedEncodingException {
                ...
                try {
                    ...
                    UpdateCustomerResponse response = gson.fromJson(mJson, UpdateCustomerResponse.class);
