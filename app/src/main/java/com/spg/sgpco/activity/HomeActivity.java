...
public class HomeActivity extends BaseActivity implements MenuAdapter.OnItemClickListener {
    ...
    private ArrayList<MyMenuItem> getMainList() {
        ...
        myMenuItems.add(new MyMenuItem(10, getResources().getString(R.string.about_system_heat), R.drawable.about_gender_floor_logo, getResources().getColor(R.color.ten), getResources().getColor(R.color.redColor)));
