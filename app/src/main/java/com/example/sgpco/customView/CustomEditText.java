package com.example.sgpco.customView;
...
import com.example.sgpco.baseView.BaseEditText;
import com.example.sgpco.baseView.BaseImageView;
import com.example.sgpco.baseView.BaseTextView;
import com.example.sgpco.enums.InputTypeEnum;
import com.example.sgpco.listener.OnEditTextChangeListener;
...
//        if (error != null) {
//            image.setVisibility(VISIBLE);
//            image.setImageDrawable(getResources().getDrawable(R.drawable.ic_error));
